...
public class TestCnpOnline {
    ...
    public void testDeActivateReversalWithOverrides() throws Exception {
        ...
        when(
                mockedCommunication
                        .requestToServer(
                                matches(".*?<cnpOnlineRequest merchantId=\"905\" merchantSdk=.*version=\"12.8\" xmlns=\"http://www.vantivcnp.com/schema\">.*?"
                                ...
                                any(Properties.class)))
                .thenReturn(
                        "<cnpOnlineResponse version='12.8' response='0' message='Valid Format' xmlns='http://www.vantivcnp.com/schema'><deactivateReversalResponse><cnpTxnId>123456</cnpTxnId></deactivateReversalResponse></cnpOnlineResponse>");
        cnp.setCommunication(mockedCommunication);
        CnpOnlineRequest overrides = new CnpOnlineRequest();
        overrides.setMerchantId("905");
