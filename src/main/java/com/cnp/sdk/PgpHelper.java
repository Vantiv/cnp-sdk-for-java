...
public class PgpHelper {
    ...
    public static void encrypt(String encryptInput, String encryptOutput, String publicKey) {
        ...
        try {
            ...
            throw new CnpBatchException("The batch file could not be encrypted. Check the public key entered. ", e);
        }
        if(0 != exitVal){
            throw new CnpBatchException("The batch file could not be encrypted. Check the public key entered. " + response);
        }
    }
    ...
    public static void decrypt(String decryptInput, String decryptOutput, String passphrase){
        ...
        try {
            ...
            throw new CnpBatchException("The response could not be decrypted. ", e);
        }
        if(0 != exitVal){
            throw new CnpBatchException("The response could not be decrypted. " + response);
        }
    }
    ...
    public static String importKey(String keyFile){
        ...
        try {
            ...
            throw new CnpBatchException("The key could not be imported. ", e);
        }
        if(0 != exitVal){
            throw new CnpBatchException("The key could not be imported. " + response);
        }
